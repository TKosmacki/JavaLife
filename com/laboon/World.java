...
public class World {
	...
	//for (int j = 0; j < 10000; j++) {
	    if (leftX == -1) { leftX = size - 1; } //will always set to same number
	    if (rightX == -1) { rightX = size - 1; } //will always set to same number
	    if (upY == -1) { upY = size - 1; } //will always set to same number
	    if (downY == -1) { downY = size - 1; } //will always set to same number
	//}
